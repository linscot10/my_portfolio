...
const Contact = () => {
  return (
    ...
    <a href='www.linkedin.com/in/lawrence-scott-osuru' className='group p-4 mt-4 hover:shadow-lg  bg-gray-100 hover:border-[1px] hover:border-gray-600 border-[1px] border-gray-200 rounded-lg'><div className='flex flex-row  gap-4'><div  className='bg-white w-16 rounded-md shadow-lg text-2xl flex justify-center items-center h-12 '><FontAwesomeIcon className='text-blue-600 group-hover:w-6 group-hover:h-12' icon={faLinkedin}   /></div><div><h2 className='text-xl'>LinkedIn</h2><p>github.com/linscot10</p></div></div></a>
    ...
    <input type='text' placeholder='Your name' className='rounded-lg p-2 border-[2px] focus:outline-none  focus:border-gray-400 border-gray-100 '/>
    </label>
    <label className='flex flex-col'>Email
    <input type='email' placeholder='you@example.com' className='rounded-lg p-2  border-[2px]  focus:outline-none focus:border-gray-400 border-gray-100 '/>
    </label>
    </div>
<div className='flex flex-col mt-7'>

    <label className='mt-7'>Subject</label>
    <input type='text' placeholder="What's this about" className='rounded-lg p-2  border-[2px]  focus:outline-none focus:border-gray-400 border-gray-100 '/>
    <label  className='mt-7'>Message</label>
    <textarea placeholder='Tell me more...' width='300' height='300' className='rounded-lg p-2 border-[2px]  focus:outline-none focus:border-gray-400 border-gray-100 '></textarea>
</div>
<button className='mt-7 bg-mint-200 py-4 px-3 hover:bg-mint-300 rounded-lg text-white '><FontAwesomeIcon icon={faPaperPlane} className='text-gray-400 mr-2 ' />Send Message</button>
    </form>
    </div>
    </div>    
    </div>
