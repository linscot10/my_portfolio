...
setLoading(true)
  ...
  return (
    ...
    <div className='  flex md:flex-row flex-col gap-4 justify-center w-full lg:w-3/4  px-5'>
    <div className=' p-7 m-3 ml-2 w-full md:w-1/2'>
    {/* <h2> Get In Touch</h2> */}
    ...
    <div className='  shadow-lg bg-gray-100 rounded-lg flex justify-center items-center    w-full md:w-1/2'>
    <form onSubmit={handleSubmit} className='w-full p-2 '>
    <div className=' flex-col  flex lg:flex-row  gap-4 w-full '>
      <label className='flex flex-col '>Name
      <input name='name' onChange={handleChange} value={formData.name} required  type='text' placeholder='Your name' className='rounded-lg w-3/4 p-2 border-[2px] focus:outline-none  focus:border-gray-400 border-gray-100 '/>
      </label>
