...
const Contact = () => {
  return (
    ...
    <input type='text' placeholder='Your name' className='rounded-lg p-2'/>
    </label>
    <label className='flex flex-col'>Email
    <input type='email' placeholder='you@example.com' className='rounded-lg p-2'/>
    </label>
    </div>
<div className='flex flex-col mt-7'>

    <label className='mt-7'>Subject</label>
    <input type='text' placeholder="What's this about" className='rounded-lg p-2'/>
    <label  className='mt-7'>Message</label>
    <textarea placeholder='Tell me more...' width='300' height='300' className='rounded-lg p-2'></textarea>
</div>
